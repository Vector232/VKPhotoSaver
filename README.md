...
## Вторая проверка.
### python3-tk-dbg
- Проблема: Предположение о различиях в ОС, как причине возникновения ошибок, не оправдалась. Новое предположение - всему виной использование отладочного интерпретатора.
- Решение: Модуль tkinter теперь подключается иначе.
### photo_sizes.
